  ...
  return (
    <>
      ...
      <section className="h-full items-center flex my-20 px-[min(3rem,5%)] gap-10 lg:flex-row flex-col">
        <div>
          <div className="flex items-center gap-1 bg-blue-400/20 px-3 py-1 rounded-full border border-slate-200 w-max mb-4">
          ...
          <h1 className="mb-6 text-4xl font-black leading-tight tracking-tight text-slate-900 sm:text-5xl lg:text-6xl">
            ...
            <span className="text-blue-700">Modern Business</span>
          </h1>
          ...
          <div className="flex flex-col items-center gap-4 sm:flex-row lg:justify-start justify-center">
            <button className="group relative flex h-12 min-w-[160px] items-center justify-center gap-2 overflow-hidden rounded-lg bg-blue-600 px-8 text-base font-bold text-white shadow-lg shadow-blue-500/25 transition-all hover:bg-blue-700 hover:shadow-blue-500/40 active:scale-95">
        ...
        <div className="relative order-1 lg:order-2 w-[100%] lg:w-1/2 flex-shrink-0">
          <div className="absolute -top-12 -right-12 -z-10 h-64 w-64 rounded-full bg-primary/10 blur-3xl"></div>
          <div className="absolute -bottom-12 -left-12 -z-10 h-64 w-64 rounded-full bg-purple-500/10 blur-3xl"></div>
          <div className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl shadow-2xl shadow-slate-200/50 bg-slate-200">
            ...
            />
            <div className="absolute bottom-6 left-6 right-6 lg:left-8 lg:right-auto lg:w-64 rounded-xl bg-white/90 p-4 shadow-lg backdrop-blur-sm ring-1 ring-slate-900/5">
